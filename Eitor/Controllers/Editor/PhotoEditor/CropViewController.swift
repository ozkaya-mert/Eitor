...
open class CropViewController: UIViewController {
    ...
    @objc func constrain(_ sender: UIBarButtonItem) {
        ...
        let original = UIAlertAction(title: "Orijinal", style: .default) { [unowned self] action in
        ...
        let square = UIAlertAction(title: "Kare", style: .default) { [unowned self] action in
...
//            self.cropView?.cropAspectRatio = ratio
        ...
        let cancel = UIAlertAction(title: "İptal", style: .default) { [unowned self] action in
